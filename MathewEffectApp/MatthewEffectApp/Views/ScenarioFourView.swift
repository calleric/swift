...
struct ScenarioFourView: View {
    @ObservedObject var mathewGame = MatthewViewModel(allowAgentsWithZero: false)
        ...
        ZStack {
            ...
            VStack {
                CoinBarChartView(mathewGame: mathewGame,
                                 chartTitle: "4: Agents with zero coin are out",
                                 displayFailedTransactionCount: false)
...
struct ScenarioFourView_Previews: PreviewProvider {
