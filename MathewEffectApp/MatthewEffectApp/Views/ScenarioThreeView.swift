...
struct ScenarioThreeView: View {
    @ObservedObject var mathewGame = MatthewViewModel(allowNegativeCount: true)
        ...
        ZStack {
            ...
            VStack {
                CoinBarChartView(mathewGame: mathewGame,
                                 chartTitle: "3: Allow negative coin count",
...
struct ScenarioThreeView_Previews: PreviewProvider {
