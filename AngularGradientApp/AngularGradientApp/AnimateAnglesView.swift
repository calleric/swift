        ...
        VStack {
            ...
            VStack(alignment: .trailing)  {
                HStack() {
                    ...
                    Text("Start Angle: ")
                        .font(.title2)
                    Text("\(startAngle.degrees, specifier: "%.2F")")
                        .font(.title)
                        .frame(width: 130)
                ...
                HStack() {
                    ...
                    Text("End Angle: ")
                        .font(.title2)
                    Text("\(endAngle.degrees, specifier: "%.2F")")
                        .font(.title)
                        .frame(width: 130)
                        .animation(Animation.easeInOut.speed(0.6),
                                   value: endAngle)
...
struct AnimateAnglesView_Previews: PreviewProvider {
